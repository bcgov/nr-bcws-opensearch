...
/**
 * Tika parser for the supplied documents in WFDM. This will parse a supplied
 * file content using Tikas autodetect parser, which should handle most mime types we'll be
 * expecting.
 */
public class TikaParseDocument {

  // Private constructor hides the implicit public constructor
  private TikaParseDocument() {
    /* empty */ }

  /**
   * Parse the provided binary input stream and return the Tika parsed result
   * 
   * @param stream The Input Stream
   * @return A String representing the processed document
  ...
  public static String parseStream(InputStream stream, String mimeType)
    ...
    // Run the parse. This will populate the string writer with the resulting
    // content
    // and populate meta, parse context, etc.
    parser.parse(stream, handler, tikaMetadata, parseContext);
    // Once the parse is complete, we want to clean and sanitze the output
    // For now, we'll remove small stop words from the text
    extractedContent = removeStopWords(sw.toString().replace("\n", "").replace("\r", ""));

    // Finalize the result and return
    return assembleExtractionResult(extractedContent, tikaMetadata);
  }

  @SuppressWarnings("unchecked")
  private static String assembleExtractionResult(String extractedText, Metadata tikaMetadata) {
  ...
  // Listing of stop words we're checking for
  // For now this is fine here, but we could move it into an external file
  private static String[] STOP_WORDS = new String[] { "3a", "3b", "3d", "6b", "6o", "a", "a1", "a2", "a3 ",
      ...
      "as", "a's", "aside", "ask", "asking", "associated", "at", "au", "auth", "av", "available", "aw ",
      "away", "awfully", "ax", "ay", "az", "b", "b1", "b2", "b3", "ba", "back", "bc", "bd", "be ",
      ...
      "better", "between", "beyond", "bi", "bill", "biol", "bj", "bk", "bl", "bn", "both", "bottom", "bp ",
      "br", "brief", "briefly", "bs", "bt", "bu", "but", "bx", "by", "c", "c1", "c2", "c3", "ca", "call ",
      "came", "can", "cannot", "cant", "can't", "cause", "causes", "cc", "cd", "ce", "certain", "certainly ",
      "cf", "cg", "ch", "changes", "ci", "cit", "cj", "cl", "clearly", "cm", "c'mon", "cn", "co", "com ",
      ...
      "e3", "ea", "each", "ec", "ed", "edu", "ee", "ef", "effect", "eg", "ei", "eight", "eighty ",
      "either", "ej", "el", "eleven", "else", "elsewhere", "em", "empty", "en", "end", "ending", "enough ",
      "entirely", "eo", "ep", "eq", "er", "es", "especially", "est", "et", "et-al", "etc", "eu", "ev ",
      "even", "ever", "every", "everybody", "everyone", "everything", "everywhere", "ex", "exactly ",
      "example", "except", "ey", "f", "f2", "fa", "far", "fc", "few", "ff", "fi", "fifteen", "fifth ",
      "fify", "fill", "find", "fire", "first", "five", "fix", "fj", "fl", "fn", "fo", "followed ",
      "following", "follows", "for", "former", "formerly", "forth", "forty", "found", "four", "fr", "from ",
      "front", "fs", "ft", "fu", "full", "further", "furthermore", "fy", "g", "ga", "gave", "ge", "get ",
      ...
      "itself", "iv", "i've", "ix", "iy", "iz", "j", "jj", "jr", "js", "jt", "ju", "just", "k", "ke ",
      "keep", "keeps", "kept", "kg", "kj", "km", "know", "known", "knows", "ko", "l", "l2", "la ",
      "largely", "last", "lately", "later", "latter", "latterly", "lb", "lc", "le", "least", "les", "less ",
      "lest", "let", "lets", "let's", "lf", "like", "liked", "likely", "line", "little", "lj", "ll", "ll ",
      "ln", "lo", "look", "looking", "looks", "los", "lr", "ls", "lt", "ltd", "m", "m2", "ma", "made ",
      ...
      "rh", "ri", "right", "rj", "rl", "rm", "rn", "ro", "rq", "rr", "rs", "rt", "ru", "run", "rv ",
