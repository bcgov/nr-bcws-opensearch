...
locals {
  ...
  env_lowercase = "prd"
  env_full = "PRODUCTION"
  document_api_url = "https://bcwsapi.nrs.gov.bc.ca/wfdm-document-management-api/documents/"
  document_token_url = "https://wfapps.nrs.gov.bc.ca/pub/oauth2/v1/oauth/token?disableDeveloperFilter=true&grant_type=client_credentials"
